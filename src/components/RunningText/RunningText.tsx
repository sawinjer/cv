...
import {useAnimationFrame, useMotionValue, useScroll, useSpring, useTransform, useVelocity, wrap} from "framer-motion";
...
export const RunningText = React.forwardRef<HTMLDivElement, Props>(({velocity = 5, children}, forwardRef) => {
    ...
    const handleRefAssign = useCallback((element: HTMLDivElement | null) => {
        ref.current = element;
